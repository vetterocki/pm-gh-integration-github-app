...
@Singleton
class PullRequestSynchronizeStatusHandler(
    ...
    override fun onEvent(@PullRequest.Synchronize eventPayload: GHEventPayload.PullRequest) = handleEvent(eventPayload)
}